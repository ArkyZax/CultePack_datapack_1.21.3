...
summon minecraft:spider ~ ~20 ~ {Health:500,active_effects:[{id:"minecraft:slow_falling",duration:80,amplifier:1}],attributes:[{id:"generic.max_health",base:500f}],Passengers:[{id:stray,Tags:["spider_cowboy"],DeathLootTable:"cultepack:entities/spider_cowboy",CustomName:'[{"text":"SPIDERBOY","color":"gold","bold":true}]',Health:500,ArmorItems:[{},{},{},{id:carved_pumpkin,components:{custom_model_data:10},Count:1}],ArmorDropChances:[0f,0f,0f,0.00f],HandItems:[{id:bow,tag:{Enchantments:[{id:flame,lvl:1},{id:infinity,lvl:1},{id:multishot,lvl:1},{id:power,lvl:10},{id:punch,lvl:2},{id:unbreaking,lvl:3}]},Count:1},{id:shield,Count:1}],HandDropChances:[0.00f,0f],attributes:[{id:"generic.attack_speed",base:5f},{id:"generic.max_health",base:500f}]}]}

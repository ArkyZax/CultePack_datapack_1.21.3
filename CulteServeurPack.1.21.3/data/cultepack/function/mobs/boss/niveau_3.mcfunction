...
summon minecraft:zombie ~ ~20 ~ {CustomName:'[{"text":"ROI ZOMBIE","color":"dark_red","bold":true}]',HandItems:[{id:carved_pumpkin,components:{custom_model_data:12},Count:1},{id:carved_pumpkin,components:{custom_model_data:12},Count:1}],ArmorItems:[{},{},{},{id:carved_pumpkin,components:{custom_model_data:11},Count:1}],HandDropChances:[0f,0f],ArmorDropChances:[0f,0f,0f,0f],active_effects:[{id:"minecraft:slow_falling",duration:80,amplifier:1}],CustomNameVisible:1b,Health:800,Tags:["roi_zombie"],attributes:[{id:"generic.attack_damage",base:20f},{id:"generic.movement_speed",base:0.3f},{id:"generic.max_health",base:800f}]}
